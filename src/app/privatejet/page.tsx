...
export default function PrivateJet() {
  ...
  <path d="M23.7333 25.6L21.3333 14.6667L26 10C28 8 28.6667 5.33333 28 4C26.6667 3.33333 24 4 22 6L17.3333 10.6667L6.4 8.26667C5.73333 8.13333 5.2 8.4 4.93333 8.93333L4.53333 9.6C4.26667 10.2667 4.4 10.9333 4.93333 11.3333L12 16L9.33333 20H5.33333L4 21.3333L8 24L10.6667 28L12 26.6667V22.6667L16 20L20.6667 27.0667C21.0667 27.6 21.7333 27.7333 22.4 27.4667L23.0667 27.2C23.6 26.8 23.8667 26.2667 23.7333 25.6Z" stroke="black" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span>
              </span>
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-1">Private Aviation Charter</h2>
                <span className="text-[#BF872D] font-medium text-base">Your Schedule. Your Destination. Your Aircraft.</span>
              </div>
            </div>
            <p className="text-gray-300 mb-6">
              Access the world's most exclusive aircraft through our curated network of certified operators. From light jets for regional meetings to long-range aircraft for international ventures.
            </p>
...
</svg></span> Light, Mid-Size, & Heavy Jets Available On-Demand</li>
              <li className="flex items-start gap-2"><span className="text-[#BF872D] mt-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M21.8006 9.9995C22.2573 12.2408 21.9318 14.5709 20.8785 16.6013C19.8251 18.6317 18.1075 20.2396 16.0121 21.1568C13.9167 22.0741 11.5702 22.2453 9.36391 21.6419C7.15758 21.0385 5.2248 19.6969 3.88789 17.8409C2.55097 15.9849 1.89073 13.7267 2.01728 11.4429C2.14382 9.15904 3.04949 6.98759 4.58326 5.29067C6.11703 3.59375 8.18619 2.47393 10.4457 2.11795C12.7052 1.76198 15.0184 2.19136 16.9996 3.3345" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9 11L12 14L22 4" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span> Dedicated Flight Coordination & Planning</li>
              <li className="flex items-start gap-2"><span className="text-[#BF872D] mt-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M21.8006 9.9995C22.2573 12.2408 21.9318 14.5709 20.8785 16.6013C19.8251 18.6317 18.1075 20.2396 16.0121 21.1568C13.9167 22.0741 11.5702 22.2453 9.36391 21.6419C7.15758 21.0385 5.2248 19.6969 3.88789 17.8409C2.55097 15.9849 1.89073 13.7267 2.01728 11.4429C2.14382 9.15904 3.04949 6.98759 4.58326 5.29067C6.11703 3.59375 8.18619 2.47393 10.4457 2.11795C12.7052 1.76198 15.0184 2.19136 16.9996 3.3345" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9 11L12 14L22 4" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span> Catering & Ground Transportation Coordination</li>
              <li className="flex items-start gap-2"><span className="text-[#BF872D] mt-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M21.8006 9.9995C22.2573 12.2408 21.9318 14.5709 20.8785 16.6013C19.8251 18.6317 18.1075 20.2396 16.0121 21.1568C13.9167 22.0741 11.5702 22.2453 9.36391 21.6419C7.15758 21.0385 5.2248 19.6969 3.88789 17.8409C2.55097 15.9849 1.89073 13.7267 2.01728 11.4429C2.14382 9.15904 3.04949 6.98759 4.58326 5.29067C6.11703 3.59375 8.18619 2.47393 10.4457 2.11795C12.7052 1.76198 15.0184 2.19136 16.9996 3.3345" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9 11L12 14L22 4" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span> International Flight Permits & Customs Handling</li>
              <li className="flex items-start gap-2"><span className="text-[#BF872D] mt-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M21.8006 9.9995C22.2573 12.2408 21.9318 14.5709 20.8785 16.6013C19.8251 18.6317 18.1075 20.2396 16.0121 21.1568C13.9167 22.0741 11.5702 22.2453 9.36391 21.6419C7.15758 21.0385 5.2248 19.6969 3.88789 17.8409C2.55097 15.9849 1.89073 13.7267 2.01728 11.4429C2.14382 9.15904 3.04949 6.98759 4.58326 5.29067C6.11703 3.59375 8.18619 2.47393 10.4457 2.11795C12.7052 1.76198 15.0184 2.19136 16.9996 3.3345" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9 11L12 14L22 4" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span> Empty Leg Opportunities For Cost Optimization</li>
              <li className="flex items-start gap-2"><span className="text-[#BF872D] mt-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M21.8006 9.9995C22.2573 12.2408 21.9318 14.5709 20.8785 16.6013C19.8251 18.6317 18.1075 20.2396 16.0121 21.1568C13.9167 22.0741 11.5702 22.2453 9.36391 21.6419C7.15758 21.0385 5.2248 19.6969 3.88789 17.8409C2.55097 15.9849 1.89073 13.7267 2.01728 11.4429C2.14382 9.15904 3.04949 6.98759 4.58326 5.29067C6.11703 3.59375 8.18619 2.47393 10.4457 2.11795C12.7052 1.76198 15.0184 2.19136 16.9996 3.3345" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9 11L12 14L22 4" stroke="#BF872D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span> Fractional Ownership Consultation</li>
            </ul>
            <div className="flex items-center gap-4 mb-4">
              <span className="text-[#BF872D] font-semibold text-lg">Starting from $3,500+ /hour</span>
              <a
                href="#reserve"
          ...
          <div className="flex-1 flex justify-center">
            <Image src="/Private Jet Charter.png" alt="Private Jet" width={480} height={320} className="rounded-2xl shadow-lg object-cover" />
          </div>
        </div>
      </section>
